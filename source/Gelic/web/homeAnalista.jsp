    ...
    <head>
       ...
       <table class="nomeSistema">
        ...
        <table class="menu">
            <tr>
                <th class="menuItem" >
                    <a href="Gelic?comando=CadastroUsuarios">Contratos</a>
                </th>
                <th class="menuItem" >
                    <a href="Gelic?comando=CadastroModalidades">Incluir Contrato</a>                    
                </th>
                <th class="menuItem" >
                    <a href="Gelic?comando=CadastroSistemas">Manter NotaFiscalVenda</a>                    
                </th>
                <th class="menuItem" >
                    <a href="Gelic?comando=CadastroSistemas">Manter NotaFiscalCompra</a>                    
                </th>
                <th class="menuItem" >
