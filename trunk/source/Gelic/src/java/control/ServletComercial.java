...
import control.commands.GravarItemLote;
...
import control.commands.GravarProposta;
...
import control.commands.NovaProposta;
...
public class ServletComercial extends HttpServlet {
    ...
    private void carregaComandos() {
        ...
        comandos.put("GravarProposta", new GravarProposta());
