 ...
 * @author Adriano
 */
public class ExcluirItemLote implements Comando {
  ...
  public String executar(HttpServletRequest req) throws ExcecaoComando {
    try {
      ...
      return form.preparaExclusao(util.Request.getParameter(req, "itemLote"));
    } catch (SQLException ex) {
      Logger.getLogger(
              ExcluirItemLote.class.getName()).log(Level.SEVERE, null, ex);
